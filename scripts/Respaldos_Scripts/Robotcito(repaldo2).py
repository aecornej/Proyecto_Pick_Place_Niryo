...
try:
    ...
    # RESTAURADO: Carga de aproximaciones articulares
...
def ejecutar_movimiento(id_punto, cliente_mqtt):
    ...
    # RESTAURADO: 1. APROXIMACIÓN AÉREA AL PICK
    cliente_mqtt.publish(TOPIC_HMI, f"Aproximando al área de recolección ({id_punto})...")
    ...
    # RESTAURADO: 4. APROXIMACIÓN AÉREA AL PLACE
